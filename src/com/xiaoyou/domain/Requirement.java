...
public class Requirement {
    ...
    public Requirement(int price, String description, String picture, String contact_name, String phone_number, String address, String requirement_category, String user_id) {
        this.price = price;
        this.description = description;
        this.picture = picture;
        this.contact_name = contact_name;
