...
public class User {
    ...
    public User(String user_name, String user_password, String user_nickname, String user_avatar, String province, String university, String profession, String student_id, String sex, String self_introduction) {
        this.user_name = user_name;
        this.user_password = user_password;
        this.user_nickname = user_nickname;
        this.user_avatar = user_avatar;
